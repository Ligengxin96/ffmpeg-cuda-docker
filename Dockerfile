...
RUN apt-get update && apt-get install -y zip unzip git wget curl gnupg2 ca-certificates fonts-liberation libatk-bridge2.0-0 libatk1.0-0 libatspi2.0-0 libcups2 libgtk-3-0 \
